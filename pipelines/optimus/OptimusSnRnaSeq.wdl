...
import "CreateCountMatrixSnRnaSeq.wdl" as CountSnRnaSeq
...
workflow OptimusSnRnaSeq {
  ...
  scatter (bam in SplitBamByCellBarcode.bam_output_array) {
    ...
    call CountSnRnaSeq.CreateSparseCountMatrixSnRnaSeq {
      input:
  ...
  call Count.MergeCountFiles {
    input:
      sparse_count_matrices = CreateSparseCountMatrixSnRnaSeq.sparse_count_matrix,
      row_indices = CreateSparseCountMatrixSnRnaSeq.row_index,
      col_indices = CreateSparseCountMatrixSnRnaSeq.col_index
  }
